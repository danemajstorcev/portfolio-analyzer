    ...
    try {
      const result: AnalysisResult = apiKey
        ...
        : await new Promise((res) =>
            setTimeout(() => res(getMockResult(text)), 1800),
          );
          ...
          <div className="col-lg-7 col-xl-6">
            <div className="hero-text mb-5">
              ...
              <p className="hero-sub">
                Upload your CV or paste it directly. The AI returns a strength
                score, actionable suggestions, and a full skills gap analysis in
                seconds.
              </p>
            </div>
